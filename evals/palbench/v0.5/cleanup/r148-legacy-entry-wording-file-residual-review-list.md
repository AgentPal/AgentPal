...
| --- | --- | --- | --- | --- |
| Older roadmap docs | `evals/palbench/v0.5/documentation/archive/docs/09-roadmap/v0.2-development-plan.md`, `evals/palbench/v0.5/documentation/archive/docs/09-roadmap/v0.3-development-plan.md`, `evals/palbench/v0.5/documentation/archive/docs/09-roadmap/v0.3-release-preparation-audit.md` | These contain old version/stage language but may still explain project evolution. | Add archive banner or move to explicit history section in a future documentation archive pass. | no |
