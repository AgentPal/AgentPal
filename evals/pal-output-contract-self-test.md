# Pal Output Contract Self-Test

## Purpose

Verify specialist Pal responses use their `core/output-contract.md`.
...
- No contract is used.
- The response ignores the contract's required output and boundaries.
- Pal response must use output contract but includes fewer than 4 mandatory contract items.
