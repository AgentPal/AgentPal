...
| Runbook | Purpose |
|---|---|
| `files/batch-rename-and-organize.md` | 批量重命名与整理 |
| `documents/document-to-summary.md` | 文档摘要 |
| `spreadsheets/table-cleaning-plan.md` | 表格清洗 |
| `pdf/pdf-extraction-and-review.md` | PDF 提取与审查 |
