# Task Follow-Up Principles

Task follow-up should make ownership, status, next step, and waiting state visible. If ownership is unknown, mark it unknown instead of guessing.
