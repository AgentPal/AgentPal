...
User goal, research question, source inventory, evidence matrix, confidence notes, target deliverable, and current contacts/registry.

## Steps

1. Use AI judgement to identify whether Vega remains owner or another Pal should be consulted, delegated to, or handed off.
2. Confirm the target Pal exists in contacts/registry.
