...
- `existing-pal-composite-upgrade-eval.md`: checks AI judgement classification for existing Pal composite upgrades without keyword routing or direct high-impact edits.
