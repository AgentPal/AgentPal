...
Memory stores extracted long-term lessons, verification preferences, quality
decisions, routing lessons, and references that help future continuity. It is
not a place for full task reports.

## What Belongs Here

- Reviewed long-term lessons from Quinn verification work.
...
- Full completion reports, audit reports, or validation records; reports belong
  in `reports/`.
...
| `runtime/` | Runtime evidence and tool-use memory area | `present` | Preserve `not-run`, `missing`, and runtime-availability boundaries. |
...
| --- | --- | --- |
| Quality gate lessons | Future validation reports | `needs-review` |
| False-completion detection lessons | Future review evidence | `needs-review` |
...
Quinn memory assets stay in the AgentPal central workspace or approved central
