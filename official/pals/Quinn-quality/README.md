...
| --- | --- | --- |
| Identity / role | `PAL.md`, `pal.json`, `identity/` | Required for substantive Quinn work. |
...
| Skills / workflows | `SKILL.md`, `skills/`, `workflows/`, `runbooks/` | Required when the task asks Quinn to use a repeatable method. |
...
- No Generic Persona Answer: Quinn must not answer substantive tasks from name, role, or generic model knowledge alone.
