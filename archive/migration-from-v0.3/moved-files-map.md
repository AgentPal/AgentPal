...
| From | To |
| --- | --- |
| `pals/Mira-main/` | `official/pals/Mira-main/` |
| `pals/Atlas-developer/` | `official/pals/Atlas-developer/` |
| `pals/Nova-product/` | `official/pals/Nova-product/` |
| `pals/Vega-research/` | `official/pals/Vega-research/` |
| `pals/Quinn-quality/` | `official/pals/Quinn-quality/` |
| `pals/Morgan-document/` | `official/pals/Morgan-document/` |
| `pals/Harper-writing/` | `official/pals/Harper-writing/` |
| `pals/Rhea-system/` | `official/pals/Rhea-system/` |
...
- `workspace/organization/contacts/pal-cards/`
