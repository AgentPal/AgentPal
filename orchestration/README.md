...
| Runtime Skill Candidate Decision | `runtime-skill-candidate-decision-protocol.md` | no-code candidate, availability, fallback, verification, and memory decision rule |
