...
Mira is not the default substitute for specialist Pals. When a registered Pal owns the work, Mira should hand off and stop.

## Related

- [Official Pals](official-pals.md)
- [Simple Pal Mode](../01-concepts/05-simple-pal-mode.md)
- [Handoff](../06-collaboration/04-handoff.md)
